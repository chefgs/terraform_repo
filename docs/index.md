...
### 🤖 [NVIDIA RAG Application](./nvidia-rag.md)
...
### ☁️ [Multi-Cloud Samples](./cloud-providers.md)

- **[Azure](./azure-samples.md)** — Virtual machine provisioning on Microsoft Azure
- **[GCP](./gcp-samples.md)** — Google Cloud Platform Compute instance with static IP and startup script
...
- [How to Do Unit Testing for HashiCorp Terraform Code](./terraform-unit-testing.md)

### OpenTofu vs Terraform

Comparison reference covering licensing, governance, compatibility, and decision guidance:

- [OpenTofu vs Terraform](./opentofu-vs-terraform.md)
...
### 🔌 [Custom Terraform Providers](./custom-provider.md)
...
This repository includes automated [GitHub Actions workflows](./github-actions.md) for CI/CD:
